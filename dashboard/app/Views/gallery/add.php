...
<?= $this->section('title') ?>Tambah Item Galeri<?= $this->endSection() ?>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Form Tambah Item Galeri</h5>
            </div>
            <div class="card-body">
                <form id="galleryForm" action="<?= base_url('gallery/store') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
