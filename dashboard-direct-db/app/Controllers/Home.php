  ...
  public function index()
    {
        ...
        // Prepare data
        $data = [
            'title' => 'Sewa Kapal Raja Ampat - Home',
            'featuredBoats' => $boatModel->where('is_featured', 1)->findAll(3),
            'testimonials' => $testimonialModel->where('status', 'approved')->findAll(5),
            'openTrips' => $openTripModel->getUpcomingOpenTrips(3), // Pastikan method ini ada di model
