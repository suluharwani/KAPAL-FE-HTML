...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= base_url('admin/blogs/update/' . $blog['blog_id']) ?>" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="content" name="content" rows="10" required><?= esc($blog['content']) ?></textarea>
            </div>
            
            <div class="mb-3">
                <label for="excerpt" class="form-label">Excerpt</label>
                <textarea class="form-control" id="excerpt" name="excerpt" rows="3"><?= esc($blog['excerpt']) ?></textarea>
            </div>
