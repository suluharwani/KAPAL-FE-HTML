...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group">
            <a href="<?= base_url('admin/users') ?>" class="btn btn-sm btn-outline-secondary <?= !$user['role'] ? 'active' : '' ?>">All</a>
            <a href="<?= base_url('admin/users?role=admin') ?>" class="btn btn-sm btn-outline-secondary <?= $user['role'] == 'admin' ? 'active' : '' ?>">Admins</a>
            <a href="<?= base_url('admin/users?role=customer') ?>" class="btn btn-sm btn-outline-secondary <?= $user['role'] == 'customer' ? 'active' : '' ?>">Customers</a>
        </div>
